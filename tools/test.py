...
def parse_args():
    ...
    parser.add_argument("--config",default='configs/nuscenes/occ3d/daocc_occ3d_wo_mask_lss.yaml', help="test config file path")
    parser.add_argument("--checkpoint", default='runs/wo_mask_lss/epoch_6_ema.pth',help="checkpoint file")
